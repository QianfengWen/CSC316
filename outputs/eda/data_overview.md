...
- `outputs/eda/schema_business.csv`
- `outputs/eda/schema_checkin.csv`
- `outputs/eda/schema_review.csv`
- `outputs/eda/schema_tip.csv`
- `outputs/eda/schema_user.csv`

## Nested Key Tables
- `outputs/eda/business.attributes_keys.csv`
- `outputs/eda/business.hours_keys.csv`
